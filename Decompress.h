...
uint8_t get_letter_by_way(const uint64_t &way, const uint8_t &way_length, Tree_element* root);
void decompress_data_from_file(Tree_element* root, const std::string &filename, uint8_t &length_of_last_byte, const uint8_t &last_byte);